...
import { Loader2, Mail, Lock, AlertCircle, Droplets } from 'lucide-react';
import { z } from 'zod';
...
/**
 * LoginForm component - handles user login with validation
 */
const LoginForm = () => {
        ...
        <CardHeader className="space-y-4 text-center">
          ...
          <div>
            ...
            <CardDescription className="mt-2">
              Sign in to access your irrigation predictions
            </CardDescription>
          </div>
        </CardHeader>
